...
This suite isolates bounded series creation, traversal, and conversion behavior.

---

## Test: term is series only

This runtime case exercises “term is series only” and verifies the declared messages, values, and execution result.
...
This runtime case exercises “take first direct sequence values” and verifies the declared messages, values, and execution result.
...
This runtime case exercises “drop first direct sequence values” and verifies the declared messages, values, and execution result.
...
This runtime case exercises “take last direct finite sequence values” and verifies the declared messages, values, and execution result.
...
This runtime case exercises “drop last direct finite sequence values” and verifies the declared messages, values, and execution result.
