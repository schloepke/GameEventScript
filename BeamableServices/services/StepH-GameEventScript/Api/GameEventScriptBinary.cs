...
public enum GameEventScriptBytecodeOpCode : byte
{
    ...
    StreamMin = 0xA9,
    StreamMax = 0xAA,
    StreamCollectList = 0xAB,
    StreamCollectMap = 0xAC,
    StreamCollectMapValue = 0xAD,
    StreamCollectFirst = 0xAE,
    StreamCollectLast = 0xAF,
    StreamCollectSingle = 0xB0,
    ...
    PipelineHasAny = 0xD0,
    PipelineHasAll = 0xD1,
    PipelineContainsSingle = 0xD2,
    PipelineContainsAny = 0xD3,
    PipelineContainsAll = 0xD4,
    PipelineDistinct = 0xD5,
    PipelineDistinctBy = 0xD6,
    PipelineGroupBy = 0xD7,
    PipelineReverse = 0xD8,
    PipelineSortAscending = 0xD9,
    PipelineSortDescending = 0xDA,
    PipelineOrderByAscending = 0xDB,
    PipelineOrderByDescending = 0xDC,
    PipelineTakeFirst = 0xDD,
    PipelineTakeLast = 0xDE,
    PipelineTakeHighest = 0xDF,
    PipelineTakeLowest = 0xE0,
    PipelineDropFirst = 0xE1,
    PipelineDropLast = 0xE2,
    PipelineDropHighest = 0xE3,
    PipelineDropLowest = 0xE4,
    PipelineShuffle = 0xE5,
    PipelineDraw = 0xE6,
    PipelineChoose = 0xE7,
    PipelineChooseRandom = 0xE8,
    PipelineChooseWeighted = 0xE9,
    PipelineDicePatternCountAny = 0xEA,
    PipelineDicePatternCountFace = 0xEB,
    PipelineDicePatternFullHouse = 0xEC,
    PipelineDicePatternStraight = 0xED,
    PipelineTakePatternCountAny = 0xEE,
    PipelineTakePatternCountFace = 0xEF,
    PipelineTakePatternFullHouse = 0xF0,
    PipelineTakePatternStraight = 0xF1,
    PipelineListCreateBuilder = 0xF2,
    PipelineListBuilderAdd = 0xF3,
    PipelineListBuilderFinish = 0xF4
