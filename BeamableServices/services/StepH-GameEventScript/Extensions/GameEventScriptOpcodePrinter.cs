...
public class GameEventScriptOpcodePrinter
{
    ...
    internal static OperandPart[] PrintInstruction(GameEventScriptBytecodeInstruction instruction)
    {
        return instruction.OpCode switch
        {
            ...
            GameEventScriptBytecodeOpCode.StreamOneWeighted => [TargetRegister, IteratorRegister, ItemBindingRegister, WeightEntry],
            GameEventScriptBytecodeOpCode.StreamTakeWeighted => [TargetRegister, IteratorRegister, CountImmediate, ItemBindingRegister, WeightEntry],
