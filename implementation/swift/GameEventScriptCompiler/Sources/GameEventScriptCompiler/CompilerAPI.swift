...
public final class GameEventScriptBuilder {
    ...
    @discardableResult public func addScript(_ text: String, sourceName: String? = nil) -> Self {
    ...
    @discardableResult public func withDebugInfo(_ options: GameEventScriptDebugInfoOptions = .all) -> Self {
        self.options.debugInfo = options
        return self
    }

    /// Sets the application Program version. Returns this builder.
    @discardableResult public func withProgramVersion(_ version: UInt64) -> Self {
    ...
    /// host.
    @discardableResult public func withExternalTypeCatalog(_ catalog: any GameEventScriptExternalTypeCatalogProtocol) -> Self {
    ...
    public func compile(options: GameEventScriptCompileOptions? = nil) throws -> GameEventScriptProgram {
        ...
        guard configuration.debugInfo.rawValue & ~GameEventScriptDebugInfoOptions.all.rawValue == 0 else { throw GameEventScriptAPIError.invalidArgument("Unknown debug information option") }
