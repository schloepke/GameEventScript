                ...
                while (!IsCompleted && vmState.State == Processing && opcodesExecuted < maxSteps)
                {
                    ...
                    switch (instruction.OpCode)
                    {
                        ...
                        case MoveSlot:
                            ...
                            break;
                        case MemberAccess:
                            vmState.Register(instruction.DestinationSlot).VmMemberAccess(instruction.XSlot, ref vmState.Register(instruction.YSlot));
                            break;
                        case IndexAccess:
                        ...
                        case CreateDice:
                            vmState.Register(instruction.DestinationSlot).VmCreateDice(instruction.Count, instruction.ImmediateY, vmState);
                            break;
                        case CreateVector:
