...
using BindEntry = GameEventScript.Api.GameEventScriptBindingSegment.GameEventScriptBinaryBindEntry;
using BindKind = GameEventScript.Api.GameEventScriptBinaryBindKind;
