...
{
    public static readonly GameEventScriptNumberValue NaN = new(GameEventScriptBytecodeTypeKind.Float, 0, 0d, null, isInteger: false, isNaN: true, isInfinity: false, isNegativeInfinity: false);
    public static readonly GameEventScriptNumberValue Infinity = new(GameEventScriptBytecodeTypeKind.Float, 0, 0d, null, isInteger: false, isNaN: false, isInfinity: true, isNegativeInfinity: false);
    public static readonly GameEventScriptNumberValue NegativeInfinity = new(GameEventScriptBytecodeTypeKind.Float, 0, 0d, null, isInteger: false, isNaN: false, isInfinity: true, isNegativeInfinity: true);

    public static GameEventScriptNumberValue CreateInteger(long value, GameEventScriptBytecodeInstructionUnit? unit = null)
        => new(GameEventScriptBytecodeTypeKind.Integer, value, value, unit, isInteger: true, isNaN: false, isInfinity: false, isNegativeInfinity: false);
    ...
    public static GameEventScriptNumberValue CreateFloat(double value, GameEventScriptBytecodeInstructionUnit? unit = null)
    {
        ...
        return double.IsFinite(value) &&
            ...
            : new GameEventScriptNumberValue(GameEventScriptBytecodeTypeKind.Float, ToIntegerSaturated(value), value, unit, isInteger: false, isNaN: false, isInfinity: false, isNegativeInfinity: false);
    }

    public static GameEventScriptNumberValue CreatePercentage(double ratio)
        => new(GameEventScriptBytecodeTypeKind.Percentage, ToIntegerPercentage(ratio), ratio, null, isInteger: false, isNaN: double.IsNaN(ratio), isInfinity: double.IsInfinity(ratio), isNegativeInfinity: double.IsNegativeInfinity(ratio));
        ...
        bool isNegativeInfinity)
    {
        ...
        Unit = kind == GameEventScriptBytecodeTypeKind.Percentage || isNaN || isInfinity ? GameEventScriptBytecodeInstructionUnit.UnitNone : unit.ToStoredUnit();
    ...
    public override GameEventScriptBytecodeTypeKind Kind { get; }
    ...
    public override long AsInteger()
    {
        ...
        if (Kind == GameEventScriptBytecodeTypeKind.Percentage) return ToIntegerPercentage(NumberValue);
    ...
    public override double AsNumber()
        => Kind == GameEventScriptBytecodeTypeKind.Percentage ? NumberValue :
            IsNaNValue ? 0d :
    ...
    {
        value = Kind == GameEventScriptBytecodeTypeKind.Percentage
    ...
    {
        value = GesText(Kind == GameEventScriptBytecodeTypeKind.Percentage ? FormatPercentage(NumberValue) : ToString());
        return true;
    }
}
