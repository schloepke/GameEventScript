...
internal static class GesVmRegisterRange
{
    ...
    internal static void GesVmCreateRangeIterator(this GesVmState vmState, ushort destinationRegister, in GesVmValue from, in GesVmValue to, GameEventScriptSession session)
    {
        if (from.Kind is Integer && to.Kind is Integer)
        {
            ...
            {
                vmState.SetIterator(destinationRegister, new GesVmIntegerRangeIterator(0, 0, 0));
                return;
            }

            vmState.SetIterator(destinationRegister, new GesVmIntegerRangeIterator(from.IntegerValue, to.IntegerValue, 1));
        }
        else if (from.IsNumeric && to.IsNumeric)
        {
            ...
            vmState.SetIterator(destinationRegister, new GesVmFloatRangeIterator(from.AsNumeric, to.AsNumeric, 1.0d));
        }
        else
        {
            vmState.SetNothing(destinationRegister);
    ...
    internal static void GesVmCreateRangeIterator(this GesVmState vmState, ushort destinationRegister, in GesVmValue from, in GesVmValue to, in GesVmValue step, GameEventScriptSession session)
    {
        if (from.Kind is Integer && to.Kind is Integer && step.Kind is Integer)
        {
            ...
            vmState.SetIterator(destinationRegister, new GesVmIntegerRangeIterator(from.IntegerValue, to.IntegerValue, step.IntegerValue));
        }
        else if (from.IsNumeric && to.IsNumeric && step.IsNumeric)
        {
            ...
            vmState.SetIterator(destinationRegister, new GesVmFloatRangeIterator(from.AsNumeric, to.AsNumeric, step.AsNumeric));
        }
        else
        {
            vmState.SetNothing(destinationRegister);
