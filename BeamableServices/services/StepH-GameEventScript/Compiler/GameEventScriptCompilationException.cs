...
/// </summary>
public sealed class GameEventScriptSyntaxException(IReadOnlyList<GseSyntaxError> errors) : GameEventScriptCompilationException(BuildMessage(errors))
{
    /// <summary>
...
/// </summary>
public sealed class GameEventScriptModuleBuildException(IReadOnlyList<GseModuleBuildError> errors) : GameEventScriptCompilationException(BuildMessage(errors))
{
    /// <summary>
    ...
    /// </remarks>
    public IReadOnlyList<GseModuleBuildError> Errors { get; } = errors ?? throw new ArgumentNullException(nameof(errors));

    private static string BuildMessage(IReadOnlyList<GseModuleBuildError> errors)
        => errors.Count == 0
