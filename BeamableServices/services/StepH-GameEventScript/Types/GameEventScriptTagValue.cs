...
public sealed class GameEventScriptTagValue : GameEventScriptValue
{
    ...
    internal static bool IsValidTagName(string? value) => GameEventScriptTagRules.IsValidTagName(value);

    internal static bool TryNormalizeTextCast(string? value, out string tagName) => GameEventScriptTagRules.TryNormalizeTextCast(value, out tagName);
