...
public enum GameEventScriptBytecodeOpCode : byte
{
    ...
    PipelineTakeHighest = 0xDD,
    PipelineTakeLowest = 0xDE,
    PipelineDropHighest = 0xDF,
    PipelineDropLowest = 0xE0,
    PipelineShuffle = 0xE1,
    PipelineDraw = 0xE2,
    PipelineChoose = 0xE3,
    PipelineChooseRandom = 0xE4,
    PipelineChooseWeighted = 0xE5,
    PipelineDicePatternCountAny = 0xE6,
    PipelineDicePatternCountFace = 0xE7,
    PipelineDicePatternFullHouse = 0xE8,
    PipelineDicePatternStraight = 0xE9,
    PipelineTakePatternCountAny = 0xEA,
    PipelineTakePatternCountFace = 0xEB,
    PipelineTakePatternFullHouse = 0xEC,
    PipelineTakePatternStraight = 0xED,
    PipelineListCreateBuilder = 0xEE,
    PipelineListBuilderAdd = 0xEF,
    PipelineListBuilderFinish = 0xF0
