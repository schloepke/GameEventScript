...
public class GameEventScriptOpcodePrinter
{
    ...
    internal static OperandPart[] PrintInstruction(GameEventScriptBytecodeInstruction instruction)
    {
        return instruction.OpCode switch
        {
            ...
            GameEventScriptBytecodeOpCode.StreamReduce => [TargetRegister, IteratorRegister, ItemBindingRegister, ReducerEntry],
            GameEventScriptBytecodeOpCode.StreamReduceOrDefault => [TargetRegister, IteratorRegister, DefaultRegister, ItemBindingRegister, ReducerEntry],
            GameEventScriptBytecodeOpCode.StreamFold => [TargetRegister, IteratorRegister, SeedRegister, ItemBindingRegister, ReducerEntry],
            ...
            GameEventScriptBytecodeOpCode.StreamCollectFirst => [TargetRegister, IteratorRegister],
            GameEventScriptBytecodeOpCode.StreamCollectLast => [TargetRegister, IteratorRegister],
            GameEventScriptBytecodeOpCode.StreamCollectSingle => [TargetRegister, IteratorRegister],

            GameEventScriptBytecodeOpCode.PipelineStream => [TargetRegister, SourceIteratorRegister, NextEntry, ItemBindingRegister, CaptureRegisterList],
            ...
            GameEventScriptBytecodeOpCode.PipelineTakeFirst => [TargetRegister, IteratorRegister, CountImmediate],
            GameEventScriptBytecodeOpCode.PipelineTakeLast => [TargetRegister, IteratorRegister, CountImmediate],
            GameEventScriptBytecodeOpCode.PipelineTakeHighest => [TargetRegister, IteratorRegister, CountImmediate],
            GameEventScriptBytecodeOpCode.PipelineTakeLowest => [TargetRegister, IteratorRegister, CountImmediate],
            GameEventScriptBytecodeOpCode.PipelineDropFirst => [TargetRegister, IteratorRegister, CountImmediate],
            GameEventScriptBytecodeOpCode.PipelineDropLast => [TargetRegister, IteratorRegister, CountImmediate],
            GameEventScriptBytecodeOpCode.PipelineDropHighest => [TargetRegister, IteratorRegister, CountImmediate],
            GameEventScriptBytecodeOpCode.PipelineDropLowest => [TargetRegister, IteratorRegister, CountImmediate],
            GameEventScriptBytecodeOpCode.PipelineShuffle => [TargetRegister, IteratorRegister],
            GameEventScriptBytecodeOpCode.PipelineDraw => [TargetRegister, IteratorRegister, CountImmediate],
