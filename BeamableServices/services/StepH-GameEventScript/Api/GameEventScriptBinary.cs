...
public enum GameEventScriptBytecodeOpCode : byte
{
    ...
    StreamMap = 0xC0,
    StreamFilter = 0xC1,
    StreamOneWeighted = 0xC2,
    StreamTakeWeighted = 0xC3,
    StreamCollectList = 0xC4,
    StreamCollectMap = 0xC5,
    StreamCollectMapValue = 0xC6,
    Distinct = 0xC7,
    DistinctBy = 0xC8,
    GroupBy = 0xC9,
    SortAscending = 0xCA,
    SortDescending = 0xCB,
    OrderByAscending = 0xCC,
    OrderByDescending = 0xCD,
    Reverse = 0xCE,
    Shuffle = 0xCF,
    ListBuilderCreate = 0xD0,
    ListBuilderAdd = 0xD1,
    ListBuilderFinish = 0xD2,
    HasPattern = 0xD3,
    TakePattern = 0xD4,
