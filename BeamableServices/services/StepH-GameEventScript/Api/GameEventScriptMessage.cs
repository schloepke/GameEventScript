...
public sealed class GameEventScriptMessage : IEquatable<GameEventScriptMessage>
{
    ...
    /// represent argument names, and values are the corresponding <see cref="GameEventScriptBoxedValue"/> instances.
    ...
    public static GameEventScriptMessage Create(string name, IReadOnlyDictionary<string, GameEventScriptBoxedValue>? arguments) => new(name, GameEventScriptNamedArguments.Create(arguments));
    ...
    public static GameEventScriptMessage Create(string name, IReadOnlyDictionary<string, GameEventScriptBoxedValue>? arguments, IEnumerable<string>? tags) => new(name, GameEventScriptNamedArguments.Create(arguments), tags);
    ...
    /// the value is a <see cref="GameEventScriptBoxedValue"/> associated with that argument.
    /// </param>
    ...
    public static GameEventScriptMessage Create(string name, params (string name, GameEventScriptBoxedValue value)[] arguments)
        => new(name, GameEventScriptNamedArguments.CreateOrdered(arguments.Select(pair => new KeyValuePair<string, GameEventScriptBoxedValue>(pair.name, pair.value)).ToArray()));
