...
internal sealed class EventScriptCollectionPipeline
{
    private EventScriptCollectionPipeline(ExpressionNode sourceExpression, IReadOnlyList<CollectionSelectorNode> prefixSelectors, CollectionSelectorNode terminalSelector)
    {
    ...
    public static bool TryCreate(CollectionAccessExpressionNode expression, out EventScriptCollectionPipeline pipeline)
    {
        ...
        pipeline = new EventScriptCollectionPipeline(source, prefixSelectors, terminalSelector);
        return true;
    }

    public IEnumerable<EventScriptValue> ApplyPrefix(IEnumerable<EventScriptValue> items, EventScriptProjectionEvaluator projection)
    {
    ...
    public static IEnumerable<EventScriptValue> ApplyComposableSelector(
    ...
    private static IEnumerable<EventScriptValue> Filter(
        IEnumerable<EventScriptValue> items,
        EventScriptProjectionEvaluator projection,
        string identifier,
    ...
    private static IEnumerable<EventScriptValue> Select(
        IEnumerable<EventScriptValue> items,
        EventScriptProjectionEvaluator projection,
        string identifier,
