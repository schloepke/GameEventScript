...
public abstract record StatementNode : GseNode;
...
public abstract record ExpressionNode : GseNode;
...
public abstract record CollectionSelectorNode : GseNode;
...
public abstract record ObjectMatchValueNode : GseNode;
...
public abstract record DicePatternNode : GseNode;
...
public abstract record IterationSourceNode : GseNode;

public abstract record GseNode
{
    public GseSourceLocation? SourceRange { get; init; }
}
...
public sealed record ParameterNode(string? ExternalLabel, string LocalName) : GseNode
{
    public bool IsLabeled => ExternalLabel is not null;

    public string SignatureLabel => ExternalLabel ?? GseMessageSignature.UnlabeledParameterName;
}

public sealed record ArgumentNode(string? Label, ExpressionNode Expression) : GseNode
{
    public string Name => Label ?? GseMessageSignature.UnlabeledParameterName;
}

public sealed record ArgumentListNode(IReadOnlyList<ArgumentNode> Arguments) : GseNode
{
...
public sealed record EventHandlerNode(string Message, IReadOnlyList<ParameterNode> ParameterList, IReadOnlyList<StatementNode> Statements) : GseNode
{
...
public sealed record TypeDefinitionNode(string Name, IReadOnlyList<TypeFieldDefinitionNode> Fields) : GseNode;
public sealed record TypeFieldDefinitionNode(string Name, string TypeName, ExpressionNode? MinimumExpression, ExpressionNode? MaximumExpression, ExpressionNode? ComputedExpression) : GseNode;
public sealed record RuleDefinitionNode(string Name, IReadOnlyList<ParameterNode> ParameterList, ExpressionNode Expression) : GseNode
{
...
public sealed record SelectDefinitionNode(string Name, IReadOnlyList<ParameterNode> ParameterList, ExpressionNode Expression) : GseNode
{
...
public sealed record StatementBodyNode(bool IsBlock, IReadOnlyList<StatementNode> Statements) : GseNode;
...
public sealed record DictionaryEntryNode(string Key, ExpressionNode Value) : GseNode;
...
public sealed record GuardedChoiceBranchNode(ExpressionNode ValueExpression, ExpressionNode ConditionExpression) : GseNode;
...
public sealed record ObjectMatchPatternNode(IReadOnlyList<ObjectMatchEntryNode> Entries) : GseNode;
public sealed record ObjectMatchEntryNode(string Key, ObjectMatchValueNode Value) : GseNode;
