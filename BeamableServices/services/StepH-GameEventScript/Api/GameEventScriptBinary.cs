...
public enum GameEventScriptBytecodeOpCode : byte
{
    ...
    StreamMin = 0xA0,
    StreamMax = 0xA1,
    StreamCollectList = 0xA2,
    StreamCollectMap = 0xA3,
    StreamCollectMapValue = 0xA4,
    ...
    PipelineHasAny = 0xD0,
    PipelineHasAll = 0xD1,
    PipelineDistinct = 0xD2,
    PipelineDistinctBy = 0xD3,
    PipelineGroupBy = 0xD4,
    PipelineReverse = 0xD5,
    PipelineSortAscending = 0xD6,
    PipelineSortDescending = 0xD7,
    PipelineOrderByAscending = 0xD8,
    PipelineOrderByDescending = 0xD9,
    PipelineShuffle = 0xDA,
    PipelineChoose = 0xDB,
    PipelineChooseRandom = 0xDC,
    PipelineChooseWeighted = 0xDD,
    PipelineDicePatternCountAny = 0xDE,
    PipelineDicePatternCountFace = 0xDF,
    PipelineDicePatternFullHouse = 0xE0,
    PipelineDicePatternStraight = 0xE1,
    PipelineTakePatternCountAny = 0xE2,
    PipelineTakePatternCountFace = 0xE3,
    PipelineTakePatternFullHouse = 0xE4,
    PipelineTakePatternStraight = 0xE5,
    PipelineListCreateBuilder = 0xE6,
    PipelineListBuilderAdd = 0xE7,
    PipelineListBuilderFinish = 0xE8
