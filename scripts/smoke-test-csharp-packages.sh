...
consumer_packages="$repository_root/artifacts/csharp/package-consumer/packages"
...
dotnet run --project "$consumer_project" --configuration Release --no-restore -p:GesPackageVersion="$release_version" -p:GesPackageSource="$package_output" -p:RestorePackagesPath="$consumer_packages"
