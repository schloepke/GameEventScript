...
/// <param name="Kind">The specific type of build error that occurred, represented by the <see cref="GameEventScriptModuleBuildErrorKind"/> enum.</param>
/// <param name="SourceLocation">The location in the source code where the error occurred, represented by a <see cref="GameEventScriptSourceLocation"/> object.</param>
public sealed record GameEventScriptModuleBuildError(string Message, string ModuleName, string Symbol, GameEventScriptSymbolKind SymbolKind, GameEventScriptModuleBuildErrorKind Kind, GameEventScriptSourceLocation SourceLocation)
{
    /// <summary>
    /// Returns a string representation of the current <see cref="GameEventScriptModuleBuildError"/> object.
    /// </summary>
    /// <returns>
...
/// </remarks>
/// <example>
/// The <see cref="GameEventScriptModuleBuildErrorKind"/> enum is used in conjunction with <see cref="GameEventScriptModuleBuildError"/> to describe
/// specific types of build-related errors in detailed diagnostic outputs.
/// </example>
public enum GameEventScriptModuleBuildErrorKind
{
    /// <summary>
