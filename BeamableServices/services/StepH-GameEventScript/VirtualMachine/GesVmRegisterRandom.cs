...
{
    internal static void VmRandom(ref this GesVmValue dst, ref GesVmValue from, ref GesVmValue to, GameEventScriptRandomGenerator randomGenerator, ref GameEventScriptTextTable textTable)
    {
        switch (from.Kind)
        {
    ...
    internal static void VmRandomFloat(ref this GesVmValue dst, ref GesVmValue from, ref GesVmValue to, GameEventScriptRandomGenerator randomGenerator)
    {
