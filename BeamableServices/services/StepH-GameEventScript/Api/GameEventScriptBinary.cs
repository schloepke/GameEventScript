...
public enum GameEventScriptBytecodeOpCode : byte
{
    ...
    StreamMin = 0xC2,
    StreamMax = 0xC3,
    StreamOneWeighted = 0xC4,
    StreamTakeWeighted = 0xC5,
    StreamCollectList = 0xC6,
    StreamCollectMap = 0xC7,
    StreamCollectMapValue = 0xC8,
    Distinct = 0xC9,
    DistinctBy = 0xCA,
    GroupBy = 0xCB,
    SortAscending = 0xCC,
    SortDescending = 0xCD,
    OrderByAscending = 0xCE,
    OrderByDescending = 0xCF,
    Reverse = 0xD0,
    Shuffle = 0xD1,
    ListBuilderCreate = 0xD2,
    ListBuilderAdd = 0xD3,
    ListBuilderFinish = 0xD4,
    HasPattern = 0xD5,
    TakePattern = 0xD6,
