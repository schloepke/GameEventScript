...
public enum GameEventScriptBytecodeOpCode : byte
{
    ...
    StreamMin = 0xA2,
    StreamMax = 0xA3,
    StreamCollectList = 0xA4,
    StreamCollectMap = 0xA5,
    StreamCollectMapValue = 0xA6,

    #endregion

    #region Group 4 - pipeline terminals and transforms

    PipelineDistinct = 0xD0,
    PipelineDistinctBy = 0xD1,
    PipelineGroupBy = 0xD2,
    PipelineReverse = 0xD3,
    PipelineSortAscending = 0xD4,
    PipelineSortDescending = 0xD5,
    PipelineOrderByAscending = 0xD6,
    PipelineOrderByDescending = 0xD7,
    PipelineShuffle = 0xD8,
    PipelineChoose = 0xD9,
    PipelineChooseRandom = 0xDA,
    PipelineChooseWeighted = 0xDB,
    PipelineDicePatternCountAny = 0xDC,
    PipelineDicePatternCountFace = 0xDD,
    PipelineDicePatternFullHouse = 0xDE,
    PipelineDicePatternStraight = 0xDF,
    PipelineTakePatternCountAny = 0xE0,
    PipelineTakePatternCountFace = 0xE1,
    PipelineTakePatternFullHouse = 0xE2,
    PipelineTakePatternStraight = 0xE3,
    PipelineListCreateBuilder = 0xE4,
    PipelineListBuilderAdd = 0xE5,
    PipelineListBuilderFinish = 0xE6
