...
namespace GameEventScript.RuntimeConsumer;
...
internal static class Program
{
    ...
    {
        foreach (var forbidden in new[] { "GameEventScript.Compiler", "GameEventScript.Conformance" })
        {
            ...
            var dependencies = File.ReadAllText(Path.Combine(AppContext.BaseDirectory, "GameEventScript.RuntimeConsumer.deps.json"));
