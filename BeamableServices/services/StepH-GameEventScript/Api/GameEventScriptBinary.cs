...
public enum GameEventScriptBytecodeOpCode : byte
{
    ...
    Reverse = 0xC8,
    Shuffle = 0xC9,
    ListBuilderCreate = 0xCA,
    ListBuilderAdd = 0xCB,
    ListBuilderFinish = 0xCC,
    MapBuilderCreate = 0xCD,
    MapBuilderAdd = 0xCE,
    MapBuilderFinish = 0xCF,
    DistinctBuilderCreate = 0xD0,
    DistinctBuilderAdd = 0xD1,
    DistinctBuilderFinish = 0xD2,
    GroupBuilderCreate = 0xD3,
    GroupBuilderAdd = 0xD4,
    GroupBuilderFinish = 0xD5,
    OrderBuilderCreate = 0xD6,
    OrderBuilderAdd = 0xD7,
    OrderBuilderFinishAscending = 0xD8,
    OrderBuilderFinishDescending = 0xD9,
    HasPattern = 0xDA,
    TakePattern = 0xDB,
