...
using static GameEventScript.Runtime.VM.GesVmState.StateValue;
...
{
    internal static void Begin(GesVmState vmState, GesLinkedProgram program, GameEventScriptMessage message, bool matchArguments, ushort entryAddress, string handlerName, GameEventScriptContext context)
    {
        if (vmState.State is Processing)
            throw new GameEventScriptVmException(new GameEventScriptDiagnostic(GameEventScriptDiagnosticPhase.Runtime, GameEventScriptDiagnosticCodes.RuntimeVmStateConflict, "Virtual machine is already processing another message."));
            ...
            while (vmState.State == Processing && !context.RuntimeBudget.IsExhausted && opcodesExecuted < reservedSteps)
            {
                ...
                switch (instruction.OpCode)
                {
                    ...
                    case Distance2D:
                        ...
                        break;
                    case Distance3D:
                        vmState.GesVmDistance3D(instruction.DestinationRegister, vmState.Register(instruction.XRegister), vmState.Register(instruction.YRegister), vmState.Register(instruction.AU), vmState.Register(instruction.BU),
                            vmState.Register(instruction.CU), vmState.Register(instruction.DU));
                        break;
                    ...
                    case DistanceSquared3D:
                        vmState.GesVmDistanceSquared3D(instruction.DestinationRegister, vmState.Register(instruction.XRegister), vmState.Register(instruction.YRegister), vmState.Register(instruction.AU), vmState.Register(instruction.BU),
                            vmState.Register(instruction.CU), vmState.Register(instruction.DU));
                        break;
                    case LengthSquared:
                    ...
                    case Dot2D:
                        ...
                        break;
                    case Dot3D:
                        vmState.GesVmDot3D(instruction.DestinationRegister, vmState.Register(instruction.XRegister), vmState.Register(instruction.YRegister), vmState.Register(instruction.AU), vmState.Register(instruction.BU),
                            vmState.Register(instruction.CU), vmState.Register(instruction.DU));
                        break;
                    case Cross:
                    ...
                    case Cross2D:
                        ...
                        break;
                    case Cross3D:
                        vmState.GesVmCross3D(instruction.DestinationRegister, vmState.Register(instruction.XRegister), vmState.Register(instruction.YRegister), vmState.Register(instruction.AU), vmState.Register(instruction.BU),
                            vmState.Register(instruction.CU), vmState.Register(instruction.DU));
                        break;
                    case AngleBetween:
                    ...
                    case AngleBetween2D:
                        ...
                        break;
                    case AngleBetween3D:
                        vmState.GesVmAngleBetween3D(instruction.DestinationRegister, vmState.Register(instruction.XRegister), vmState.Register(instruction.YRegister), vmState.Register(instruction.AU), vmState.Register(instruction.BU),
                            vmState.Register(instruction.CU), vmState.Register(instruction.DU));
                        break;
