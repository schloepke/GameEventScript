...
`PortableTextSemantics.md`, `PortableNumberSemantics.md`, `BytecodeSpec.md`, and
`HostArchitecture.md`.
...
- Boolean, integer, float, percentage, and dice values have a numeric view.
  ...
  same unit, and binary64 comparison follows `PortableNumberSemantics.md`.
...
`PortableTextSemantics.md`. Maps and map-backed records expose keys, values,
